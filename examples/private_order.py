...
from bittrade_binance_websocket.models.order import OrderCancelRequest, OrderResponseType, OrderSide, OrderTimeInForceType, OrderType, PlaceOrderRequest, PlaceOrderResponse
...
sub1 = ready.pipe(
    add_order(messages, order_request)
)
sub = socket_connection.connect()

sub1.subscribe(
    info_observer('ADD ORDER', 'bittrade_binance_websocket')
)
